...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_save_PDF = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("view/img/pdf.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_save_PDF.setIcon(icon8)
        self.action_save_PDF.setObjectName("action_save_PDF")
        self.action_good_track = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("view/img/thumbs-up-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.action_good_track.setIcon(icon9)
        self.action_good_track.setObjectName("action_good_track")
        self.action_bad_track = QtWidgets.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("view/img/thumbs-down.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_bad_track.setIcon(icon10)
        self.action_bad_track.setObjectName("action_bad_track")
        self.action_save_all_PDF = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("view/img/pdficon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_save_all_PDF.setIcon(icon11)
        self.action_save_all_PDF.setObjectName("action_save_all_PDF")
        self.action_hide_bad_tracks = QtWidgets.QAction(MainWindow)
        self.action_hide_bad_tracks.setCheckable(True)
        self.action_hide_bad_tracks.setObjectName("action_hide_bad_tracks")
        self.action_export_to_matlab = QtWidgets.QAction(MainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("view/img/matlab64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_export_to_matlab.setIcon(icon12)
        self.action_export_to_matlab.setObjectName("action_export_to_matlab")
        self.action_plot_dE_dx = QtWidgets.QAction(MainWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("view/img/Landau.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_plot_dE_dx.setIcon(icon13)
        self.action_plot_dE_dx.setObjectName("action_plot_dE_dx")
        self.action_hide_bad_events = QtWidgets.QAction(MainWindow)
        self.action_hide_bad_events.setCheckable(True)
        self.action_hide_bad_events.setObjectName("action_hide_bad_events")
        ...
        self.menuView.addAction(self.action_hide_bad_tracks)
        self.menuView.addAction(self.action_hide_bad_events)
        ...
        self.toolBar.addAction(self.action_save_all_PDF)
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.action_good_track)
        self.toolBar.addAction(self.action_bad_track)
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.action_export_to_matlab)
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.action_plot_dE_dx)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_next_event.setShortcut(_translate("MainWindow", "F"))
        ...
        self.action_previous_event.setShortcut(_translate("MainWindow", "V"))
        ...
        self.actionFit_all_tracks.setText(_translate("MainWindow", "F&it all tracks"))
        self.action_save_PDF.setText(_translate("MainWindow", "Save PDF"))
        self.action_good_track.setText(_translate("MainWindow", "Good Track"))
        self.action_good_track.setShortcut(_translate("MainWindow", "G"))
        self.action_bad_track.setText(_translate("MainWindow", "Bad Track"))
        self.action_bad_track.setShortcut(_translate("MainWindow", "B"))
        self.action_save_all_PDF.setText(_translate("MainWindow", "Save all to PDF"))
        self.action_save_all_PDF.setToolTip(_translate("MainWindow", "Save all to PDF"))
        self.action_hide_bad_tracks.setText(_translate("MainWindow", "&Hide bad tracks"))
        self.action_export_to_matlab.setText(_translate("MainWindow", "Export to Matlab"))
        self.action_plot_dE_dx.setText(_translate("MainWindow", "Plot dE/dx"))
        self.action_hide_bad_events.setText(_translate("MainWindow", "Hide bad events"))
